 ...
 */
	...
	'admin:server' => '服务器',
	'admin:cron' => '计划任务',
	'admin:cron:record' => '最新的计划任务工作',
	'admin:cron:period' => '计划任务周期',
	'admin:cron:friendly' => '最后完成',
	'admin:cron:date' => '日期与时间',
	'admin:cron:msg' => '信息',
	'admin:cron:started' => '"%s"的计划任务开始于%s',
	'admin:cron:started:actual' => '计划任务间隔"%s"开始处理于%s',
	'admin:cron:complete' => '"%s"的计划任务完成于%s',
	...
	'admin:security:settings:protect_cron' => '保护计划任务的URLs',
	'admin:security:settings:protect_cron:help' => '持有有效令牌方能运行计划任务.',
	'admin:security:settings:protect_cron:token' => '为了使用计划任务，请使用下面的令牌，请注意每个时段的令牌是变化的.',
	'admin:security:settings:protect_cron:toggle' => '显示/隐藏计划任务URLs',
 ...
 */
	...
	'config:i18n:who_can_change_language' => "谁能改变网站语言",
	...
	'config:content:comments_group_only' => "仅限小组成员对小组内容进行评论",
	'config:content:comments_latest_first' => "最新评论在最前面",
	'config:content:comments_latest_first:help' => "控制评论列表的默认行为. 如果禁用，评论框将移到评论列表的底部",
	'config:content:comments_max_depth' => "嵌套评论的最大级数",
	'config:content:comments_max_depth:help' => "如果开启，可以对评论进行评论，直到达到设定的最大值.",
	'config:content:comments_max_depth:none' => "不允许嵌套评论",
