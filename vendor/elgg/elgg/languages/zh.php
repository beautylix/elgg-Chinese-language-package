 ...
 */
	...
	'item:site:site' => '站点',
	'collection:site:site' => '全站',
	'index:content' => '<p>欢迎来到Elgg站点.</p><p><strong>提示:</strong> 许多站点使用 <code>激活的</code> 插件将站点活动添加到这个页面上。</p>',
 ...
 */
	...
	'loggedoutrequired' => "请退出登录后查看此页面.",
	'adminrequired' => "需要管理员权限！",
	'membershiprequired' => "您不是该小组成员，请先加入该小组！",
 ...
 */
	...
	'dashboard' => "个人中心",
	'dashboard:nowidgets' => "通过个人中心可以关注与您相关的活动活动与内容。",
 ...
 */
	...
	'river:update' => '%s的更新',
	'river:delete' => '删除该活动',
	'river:delete:success' => '该活动已被删除',
	'river:delete:fail' => '该活动无法删除',
	'river:delete:lack_permission' => '你无法删除该活动，权限不够！',
 ...
 */
	...
	'user:username:help' => '请注意，更改用户名将改变所有活动的与用户相关的链接。',
...
'admin:performance' => '性能优化',
	...
	'admin:notification:make_admin:admin:subject' => '一个新的管理员已经加入%s',
	
	'admin:notification:make_admin:user:subject' => '你已成为%s的新管理员',
	'admin:notification:remove_admin:admin:subject' => '一个管理员已从%s撤出',
	
	'admin:notification:remove_admin:user:subject' => '你已不再是%s的管理员',
	'user:notification:ban:subject' => '你在%s的账户已经呗禁用',
	
	'user:notification:unban:subject' => '你在%s的账户已经解禁',
 ...
 */
	...
	'entity:subscribe' => "订阅",
	'entity:subscribe:disabled' => "你的默认通知设置阻止你订阅此内容",
	'entity:subscribe:success' => "你已经成功订阅了%s",
	'entity:subscribe:fail' => "订阅%s时发生了一个错误",
	
	'entity:unsubscribe' => "取消订阅",
	'entity:unsubscribe:success' => "你已经成功取消了来自%s的订阅",
	'entity:unsubscribe:fail' => "取消来自%s的订阅时发生了一个错误",
	
	'entity:mute' => "通知静音",
	'entity:mute:success' => "你已经成功静音了来自%s的通知",
	'entity:mute:fail' => "对来自%s的通知静音时发生了一个错误",
	
	'entity:unmute' => "取消静音",
	'entity:unmute:success' => "你已对来自%s的订阅取消静音",
	'entity:unmute:fail' => "当对来自%s的通知进行取消静音时发生了一个错误",
